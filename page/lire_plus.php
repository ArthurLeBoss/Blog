  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
            ...
            <!-- Titre -->
            <h1 class="display-4"><?= $recup['titre']?></h1>
            <!-- Catégorie -->
            <h2 class="display-5"><?=$recup['categorie']?></h2>
            <!-- Post Content -->
            <p class="lead"><?=$recup['contenu']?></p>
            <a class="btn btn-success btn-sm" href="modifier.php?id=<?= $recup['id'] ?>" role="button">Modifier</a>
            <a class="btn btn-danger btn-sm" href="../public/index.php?del=<?= $recup['id'] ?>" role="button" id="submit_suppr" name="submit_suppr">Supprimer</a>
